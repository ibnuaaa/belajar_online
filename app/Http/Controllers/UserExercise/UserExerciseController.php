...
class UserExerciseController extends Controller
{
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserExercise->save();

        Json::set('data', $this->SyncData($request, $Model->UserExercise->id));
    ...
    public function Update(Request $request)
    {
        ...
        $UserExerciseBetul = UserExercise::where('nilai', '>', '0')->where('user_lecture_id',$Model->UserExercise->user_lecture_id)->get();
        ...
        $UserLecture = UserLecture::where('id', $Model->UserExercise->user_lecture_id)->first();
