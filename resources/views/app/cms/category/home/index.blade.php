...
<div class="page-header">
    <h1 class="page-title">Category
        <a href="/category/new" class="btn btn-primary btn-sm">
        ...
        <tr>
            ...
            <td class="v-align-middle">
                <div class="btn-group btn-group-sm">
                    <a href="{{ url('/category/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="{{ url('/category/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
@include('app.cms.category.home.scripts.index')
@endsection
